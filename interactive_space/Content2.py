...
class storyContent2:
    ...
    def listen_to_space_crash(self):
        ...
        text =  [ 
            f"Hello there captain {self.name}. This is Spilo, your artificial AI built into your space suit. I need to inform you After space"
            "traveling for hundreds of years you crashland through an interdimensional wormhole. We seem to have crashlanded in an unknown world"
            "that is inhabited by elf-like creatures. Which we seem to be in an elf home and the elves seem to have healed your bones with a spell."
    ...
    def escape_window(self):
        text =[
                 "After getting up quickly, you run full speed towards the window & burst through with no fear, you stick the landing and start running at full speed ahead towards the forest and escape.""Your personal AI Spilo convinces you that it's worth leaving so you leave the planet."
    ...
    def listen_to_decline_fight(self):
        text = [
            "You decline to fight the Orcs. The governor has other plans for you. You are now treated as a traitor and sent straight to the dungeons of the elf jail." 
        ]
...
story_instance.listen_to_space_crash()
